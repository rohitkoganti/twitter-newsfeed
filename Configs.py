...
class Var:
    ...
    TRACK_USERS = config("TRACK_USERS", '@the_hindu @DDNewslive @htTweets @timesofindia @ANI @PTI_News @IndianExpress @ndtv @ndtvfeed @airnewsalerts @IndiaTodayFLASH @IndiaToday @DeccanHerald @indiacom @ians_india @XpressHyderabad @xpressandhra @NewIndianXpress @narendramodi @rashtrapatibhvn @PMOIndia')
