...
class Var:
    ...
    TRACK_USERS = config("TRACK_USERS", '@the_hindu @DDNewslive @htTweets @timesofindia @ANI @PTI_News @IndianExpress @ndtv @ndtvfeed @airnewsalerts @IndiaTodayFLASH @narendramodi @rashtrapatibhvn @PMOIndia')
    ...
    MUST_INCLUDE = config("MUST_INCLUDE", ['Venkaiah Naidu', 'Vice President of India', 'VPSecretariat', 'passes away', 'passing away', 'passed away', 'accident', 'mishap', 'demise', 'expire' ])
